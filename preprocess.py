...
def load_catalog(fname, step, init_load=False):
    ...
    core_m_infall = dtk.gio_read(fname, 'infall_mass')
...
def combine_catalogs(current_dict, prev_dict, step):
...
def preprocess_core_catalog(input_fname, output_fname, steps):
    ...
    for step in steps[-2::-1]:
        ...
        combine_catalogs(current_dict, prev_dict, step)
...
if __name__ == "__main__":
    ...
    preprocess_core_catalog(input_fname, output_fname, steps)
